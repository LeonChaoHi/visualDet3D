...
__all__ = [
    ...
    'shufflenet_v2_x1_5', 'shufflenet_v2_x2_0', 'shufflenet_v2_customized'
]
...
def shufflenet_v2_customized(pretrained=False, progress=True, **kwargs):
    """
    自定义 shufflenet 结构， 满足输出通道数[64, 128, 256]和 stride =【4, 8, 16】
    """
...
if __name__ == '__main__':
    ...
    with torch.autograd.profiler.profile(use_cuda=True, profile_memory=True) as prof:
        model(model_input)
    print(prof)
    prof.export_chrome_trace('./shufflenet_v2_profile.json')